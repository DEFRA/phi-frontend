  ...
  errorMessage: undefined,
   errors: undefined,
    ...
    mainContent: undefined,
     pageTitle: "Which format of undefined are you importing? — Check plant health information and import rules — GOV.UK", 
  ...
  it('should set error messages and return the error view', async () => {
   ...
   errorMessage: undefined,
    ...
    getHelpSection: undefined,
     ...
     hostRef: undefined, 
     mainContent: undefined, 
     pageTitle: "Which format of undefined are you importing? — Check plant health information and import rules — GOV.UK", "radiobuttonValue": undefined, 
     searchQuery: undefined
    }));
  });
});
