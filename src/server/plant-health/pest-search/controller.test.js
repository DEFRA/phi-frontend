...
describe('pestSearchController', () => {
  ...
  it('should handle request with search query', async () => {
    ...
    expect(h.view).toHaveBeenCalledWith('plant-health/pest-search/index.njk', expect.objectContaining({
     ...
     heading: "Search",
      ...
      page: "pestsearch", 
      pageTitle: "Error: What pest or disease do you want to find out about? — Check plant health information and import rules — GOV.UK",
  ...
  //  proxyFetch.mockResolvedValue({ status: 200 });
    ...
    expect(h.view).toHaveBeenCalledWith('plant-health/pest-search/index.njk', expect.objectContaining({
    errorMessage: undefined, 
    errors: undefined, getHelpSection: undefined, 
    heading: "Search",
     mainContent: undefined, 
     page: "pestsearch",
      pageTitle: "Error: What pest or disease do you want to find out about? — Check plant health information and import rules — GOV.UK", 
